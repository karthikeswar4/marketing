app.controller("ProductDetailController", [ '$scope', '$window', '$rootScope', '$state', '$stateParams','$filter', '$location', 'Utils', 'APPServices', function($scope, $window, $rootScope, $state, $stateParams, $filter, $location, Utils, APPServices) {
	
	$scope.goBack = function() {
		$state.go('home.product.search');
	};
	
	$scope.saveCampaign = function() {

		var method = "createProduct";
		if ($stateParams.record_id) method = "updateProduct"; 
